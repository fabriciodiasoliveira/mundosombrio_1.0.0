...
<div class="row">
    ...
    <div class="col-md-12">
    No sistema World of Darkness, o número de dados a se jogar para uma ação, é o valor de um atributo + o valor de uma habilidade. Para ações específicas, as próprias regras já dizem qual característica deve ser jogada.
    </div>
    <div class="col-md-12">
